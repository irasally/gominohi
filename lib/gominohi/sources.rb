  ...
  SOURCES = [
    ...
    },
    {
      ...
      areas: [
        ...
        "清田区 美しが丘3条3丁目1番・2番・3番55,札幌センター1",
      ],
      types: {
        :burn     => ["月", "木"],
        :leaf     => [],
    ...
    },
    {
      ...
      areas: [
        ...
        "清田区 美しが丘1条～3条の3丁目～10丁目（美しが丘3条3丁目1番・2番・3番55を除く）,札幌センター1",
    ...
    },
    {
      name: "minami_1",
      areas: [
        "南区 澄川2条4丁目（12番～14番）・澄川2条5丁目,札幌センター1",
        "南区 澄川3条4丁目（7番）・澄川3条5丁目・6丁目,札幌センター1",
        "南区 澄川4条4丁目（1番18号～27号、2番～11番）・澄川4条5丁目～12丁目,札幌センター1",
        "南区 澄川5条4丁目（1番・7番～9番）・澄川5条5丁目（1番～9番（9番1～5を除く））,札幌センター1",
        "南区 澄川5条6丁目（1番～8番）・澄川5条7丁目～13丁目,札幌センター1",
    ...
    },
    {
      name: "minami_2",
      areas: [
        "南区 石山○条○丁目、○番地（石山1条1丁目12番を除く）,札幌センター1",
        "南区 石山東○丁目,札幌センター1",
    ...
    },
    {
      ...
      areas: [
        ...
        "南区 澄川5条5丁目（9番1～5、10番～19番）・澄川5条6丁目（9番～14番）,札幌センター1",
    ...
    },
    {
      name: "minami_6",
      areas: [
        "南区 南沢○条○丁目、○番地（南沢1条3丁目1番5～14、20番、21番を除く）,札幌センター1",
      ],
      types: {
        :burn     => ["火", "金"],
        :leaf     => [],
    ...
    },
    {
      ...
      areas: [
        ...
        "南区 南沢1条3丁目1番5～14、20番、21番,札幌センター1",
        "南区 石山1条1丁目12番,札幌センター1",
      ],
      types: {
        :burn     => ["火", "金"],
        :leaf     => [],
    ...
    },
    {
      ...
      areas: [
        ...
        "豊平区 平岸○条○丁目,札幌センター1",
        "豊平区 美園○条○丁目,札幌センター1",
        "豊平区 月寒西1条2丁目1番45～62,札幌センター1",
        "豊平区 月寒西1条3丁目1番（35～38のみ）,札幌センター1",
        "豊平区 月寒西2条4丁目1番,札幌センター1",
        "豊平区 月寒中央通1丁目1番20,札幌センター1",
      ],
      types: {
        :burn     => ["火", "金"],
        :leaf     => [],
    ...
    },
    {
      ...
      areas: [
        ...
        "豊平区 月寒西○条○丁目（月寒西1条2丁目1番45～62・月寒西1条3丁目1番35～38・月寒西2条4丁目1番を除く）,札幌センター1",
        "豊平区 月寒中央通○丁目（月寒中央通1丁目1番20を除く）,札幌センター1",
        "豊平区 羊ヶ丘1番地,札幌センター1",
      ],
      types: {
        :burn     => ["月", "木"],
