...
gominohi g chuo_3 $2 $3 2 >> $1/area_days.csv
gominohi g chuo_4 $2 $3 2 >> $1/area_days.csv
gominohi g chuo_5 $2 $3 2 >> $1/area_days.csv
gominohi g chuo_6 $2 $3 2 >> $1/area_days.csv
echo "厚別区"
gominohi g atsubetsu_1 $2 $3 3 >> $1/area_days.csv
...
gominohi g shiroishi_3 $2 $3 3 >> $1/area_days.csv
gominohi g shiroishi_4 $2 $3 3 >> $1/area_days.csv
echo "手稲区"
gominohi g teine_1 $2 $3 1 >> $1/area_days.csv
...
gominohi g kiyota_2 $2 $3 2 >> $1/area_days.csv
...
# 4 [:not_burn, :paper, :leaf, :paper]
echo "西区"
gominohi g nishi_1 $2 $3 1 >> $1/area_days.csv
...
gominohi g minami_5 $2 $3 1 >> $1/area_days.csv
gominohi g minami_6 $2 $3 1 >> $1/area_days.csv
gominohi g minami_7 $2 $3 1 >> $1/area_days.csv
echo "豊平区"
